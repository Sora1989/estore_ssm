					...
					<div class="userCenterBox boxCenterList clearfix"
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<tr>
								...
								<td align="left">${ fn:substring(order.createtime, 0, 19) }</td>
							</tr>
							<tr>
						...
						<table width="100%" border="0" cellpadding="5" cellspacing="1"
							...
							<c:forEach items="${ order.list }" var="oi">
								<tr>
									...
									<c:set var="total" value="${ total + oi.good.estoreprice * oi.buynum }" />
								</tr>
							</c:forEach>
							<tr>
								<td colspan="5" style="text-align:right;padding-right:10px;font-size:25px;">
									商品总价&nbsp;<font color="red">&yen;${ total }</font>元
									<a href="pay.jsp?oid=${order.id}&money=${order.totalprice}">
